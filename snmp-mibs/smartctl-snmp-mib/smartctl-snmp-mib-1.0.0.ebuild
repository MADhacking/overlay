...
HOMEPAGE="https://github.com/MADhacking/smartctl-snmp-mib"
LICENSE="LGPL-3"

if [[ ${PV} = *9999* ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/MADhacking/smartctl-snmp-mib"
	EGIT_BRANCH="master"
else
	SRC_URI="https://github.com/MADhacking/smartctl-snmp-mib/archive/${PV}.tar.gz -> ${P}.tar.gz"
fi

KEYWORDS="amd64 arm x86 ~alpha hppa ~ia64 ppc ppc64 s390 sparc"
IUSE="test"
SLOT="0"
